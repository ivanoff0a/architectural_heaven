...
import PlacesList from "./components/Sidebar/Places/PlacesList";
    ...
    this.state = {
        ...
        places : [
            ...
            },
            {
                ...
                pic: 'https://media-cdn.tripadvisor.com/media/photo-s/09/48/57/5c/300.jpg',
            ...
            },
            {
                ...
                pic: 'https://cdn.syg.ma/attachments/25ebe48655e5ecd5fa1ab3bce06e5c199889420b/store/ef79b051d963a46d431977dc820b29b12dab6f91fdf09c3b4fa527f9deac/file.jpeg',
            ...
            {
                name: 'Лахта-центр',
                adress: 'Парадная ул., 1, Санкт-Петербург, Ленинградская область, 191014',
                lat: 59.987263,
                lng: 30.177687,
                style: 'Современный',
